 ...
 */
public class X5WebProgress extends FrameLayout {
    ...
    public X5WebProgress(Context context) {
        this(context, null);
    }

    public X5WebProgress(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public X5WebProgress(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private final ValueAnimator.AnimatorUpdateListener mAnimatorUpdateListener = animation -> {
        X5WebProgress.this.mCurrentProgress = (float) animation.getAnimatedValue();
        X5WebProgress.this.invalidate();
    };
    ...
    public X5WebProgress setHeight(int heightDp) {
