 ...
 */
public class UiWebProgressBar extends FrameLayout {
    ...
    public UiWebProgressBar(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public UiWebProgressBar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private final ValueAnimator.AnimatorUpdateListener mAnimatorUpdateListener = animation -> {
        UiWebProgressBar.this.mCurrentProgress = (float) animation.getAnimatedValue();
        UiWebProgressBar.this.invalidate();
    };
    ...
    public UiWebProgressBar setHeight(int heightDp) {
