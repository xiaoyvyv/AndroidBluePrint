...
import com.xiaoyv.leveldb.table.FileChannelTable;
import com.xiaoyv.leveldb.table.Table;
import com.xiaoyv.leveldb.table.UserComparator;
import com.xiaoyv.leveldb.util.Closeables;
import com.xiaoyv.leveldb.util.Finalizer;
    ...
    public TableCache(final File databaseDir, int tableCacheSize, final UserComparator userComparator, final boolean verifyChecksums) {
        ...
        cache = CacheBuilder.newBuilder()
                ...
                .build(new CacheLoader<Long, TableAndFile>() {
                    @NonNull
                    @Override
                    public TableAndFile load(@NonNull Long fileNumber)
                            throws IOException {
